...
export const DEFAULT_REPORT_PROMPT = [
    ...
    '',
    'Pull real numbers with your tools — never state a price from memory. Work to the matching',
    'playbooks rather than from general knowledge, loading each with get_analysis_playbook first:',
    '- Backdrop: market-breadth-analyzer and exposure-coach for stocks, crypto-regime-analyzer for',
    '  crypto. If a playbook cannot be loaded, say the reading is unavailable instead of',
    '  substituting your own judgement.',
    '- Setups: vcp-screener or canslim-screener for stocks, breakout-trade-planner for either.',
    '',
    'Then cover:',
