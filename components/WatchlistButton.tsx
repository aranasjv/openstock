    ...
    if (type === "icon") {
        return (
            <button
                ...
                className={`flex items-center justify-center p-2 rounded-full transition ${added ? "text-yellow-400 hover:bg-yellow-400/10" : "text-gray-400 hover:text-white hover:bg-white/10"} ${loading ? "opacity-50 cursor-wait" : ""}`}
                onClick={handleClick}
                disabled={loading}
            >
                <svg
